...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Shopify Services | Abdur Rehman" },
      {
        name: "description",
        content:
          "Shopify development, theme customization, custom sections, store optimization, and ongoing Shopify support.",
      },
      { property: "og:title", content: "Shopify Services | Abdur Rehman" },
      {
        property: "og:description",
        content:
          "Professional Shopify development, store customization, custom sections, and ongoing Shopify support.",
      },
    ...
    <SiteLayout>
      <PageIntro
        ...
        title={
          <>
            Professional
            <span className="italic gold-text">Shopify Services</span>
          </>
        }
        lede="Shopify development, theme customization, custom sections, performance improvements, and ongoing support tailored to your business."
      />
    ...
    <div>
      ...
      <ul className="grid gap-3 sm:grid-cols-2">
        {items.map((it, i) => (
          <li
            key={i}
            className="flex gap-3 rounded-xl border border-border p-4 text-sm text-foreground/90"
          >
