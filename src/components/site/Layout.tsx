      ...
      <div className="container-x flex h-16 items-center justify-between md:h-20">
        <Link to="/" className="group flex items-center gap-2.5">
          ...
          <span className="flex flex-col leading-none">
            <span className="font-display text-lg text-foreground">Abdur Rehman</span>
            <span className="eyebrow !text-[9px] !tracking-[0.28em]">Shopify Developer</span>
          </span>
        </Link>
    ...
    <footer className="border-t border-border mt-24">
      <div className="container-x py-16 md:py-24">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <p className="eyebrow">Abdur Rehman</p>
          ...
          <FooterCol
            ...
            links={[
              ...
              { to: "/services", label: "Responsive Design" },
              { to: "/services", label: "Performance Optimization" },
              { to: "/services", label: "Shopify Store Setup" },
              { to: "/services", label: "Custom Shopify Sections" },
            ]}
          />
          <div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-xs text-muted-foreground">
          <p>
            © {new Date().getFullYear()} Abdur Rehman. Shopify Developer • E-commerce Specialist
          </p>
          <p className="font-mono">
            Built with Shopify Liquid, HTML, CSS, JavaScript & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
    ...
    <section className="container-x py-24 md:py-32">
      <div className="card-glass grain relative overflow-hidden rounded-3xl p-10 md:p-20 text-center">
        ...
        <p className="relative mt-6 text-muted-foreground max-w-xl mx-auto">
          Have a Shopify project in mind? Share your requirements and I'll get back to you within
          one business day to discuss the best solution.
        </p>
